...
import org.kaddiya.grorchestrator.models.Host
import org.kaddiya.grorchestrator.models.Instance
...
class GrorProjectSerialiserImplSpec extends Specification {
    ...
    def "constructGrorProject should return a properly constructed object for GrorProject"(){
        ...
        assert actualProject.equals(expectedProject) : "Something went wrong in the parsing"
